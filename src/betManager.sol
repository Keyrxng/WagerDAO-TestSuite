...
//     require(endTime - startTime >= 1 minutes, "Each match should be atleast 105 minutes."); // Prevent errors with times inserted.
//     // 180 minutes in production
//     require(endTime - startTime <= 3 minutes, "Duration should be less than 180 miutes."); // Prevent errors with times inserted.
